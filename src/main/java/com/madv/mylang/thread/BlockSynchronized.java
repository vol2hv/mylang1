...
public class BlockSynchronized {
   ...
   static void getMoney(int amount) { // принцип WC
        System.err.println("До захвата");
       synchronized (new Object()){ // синхронизируемый блок. В качестве ключа может выступать любой Object
           if (amount <= money) {
        ...
        System.err.println("После захвата");
    }
